...
type PropsTrackDetails = {
    ...
    trackDetailsError: string | null
}

export function TrackDetails({selectedTrackID, selectedTrack, trackDetailsError}: PropsTrackDetails) {
    ...
    return (
        <div>
            ...
            {trackDetailsError && <span>{trackDetailsError}</span>}
            {selectedTrack && <div>
